<template>
  <div>
    <v-card-text style="padding-top:100px;">
      <v-container fluid>
        <v-row row>
          <v-col class="col-12 col-sm-6 offset-sm-3 col-md-4 offset-md-4">
            <div class="wrapper">
              <svg
        ...
        <v-row row>
          <v-col class="col-12 col-sm-6 offset-sm-3 col-md-4 offset-md-4 d-flex flex-column align-center justify-center">
            <v-card-title>
              <p>Sorry, we did not found your page.</p>
            </v-card-title>
            <v-card-actions>
